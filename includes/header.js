 ...
 *   - Burger menu mobile
 *   - Badge panier
 *   - Boutons "Ajouter au panier" avec vérification du stock
 *   - Styles dynamiques recherche et alertes
 */
...
document.addEventListener('click', async e => {
    ...
    try {
        ...
        if (data.connected) {
            // Utilisateur connecté → BDD avec vérification stock
            ...
            if (addData.error === 'rupture') {
                ...
                setTimeout(() => {
                    ...
                    btn.style.background = 'var(--grey-600)';
                }, 2000);
                return;
            }
            ...
            // Invité → localStorage (pas de vérif stock temps réel)
            const cart = JSON.parse(localStorage.getItem('mm_cart') || '[]');
