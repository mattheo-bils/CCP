...
// Récupération du produit depuis la BDD
$produit    = null;
$suggestions = [];
...
try {
    ...
    // Fallback statique Bleach tome 2
    $produit = [
        'id'            => 7,
        'titre'         => 'Bleach',
        'auteur'        => 'Tite Kubo',
        ...
        'description'   => "Bleach raconte l'histoire d'Ichigo Kurosaki, un adolescent capable de voir les esprits, qui obtient les pouvoirs d'un Shinigami après avoir rencontré Rukia Kuchiki.",
    ];
    $suggestions = [];
}
